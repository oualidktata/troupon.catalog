...
namespace Troupon.Catalog.Api.Authentication
{
    public class KeyCloackAuthenticationHandler : AuthenticationHandler<TokenAuthenticationOptions>
    {
        ...
        public KeyCloackAuthenticationHandler(IOptionsMonitor<TokenAuthenticationOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, IServiceProvider serviceProvider)
        ...
        protected override Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            try
            {
                ...
                var identity = new ClaimsIdentity(claims, nameof(KeyCloackAuthenticationHandler));
