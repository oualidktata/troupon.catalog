...
namespace Troupon.Catalog.Service.Api.DependencyInjectionExtensions
{
    public static class AddAuthenticationExtensions
    {
        ...
        //    return services;
        //}
        public static IServiceCollection AddAuthenticationToApplication(this IServiceCollection services,IAuthService authenticationService, IConfiguration configuration, IWebHostEnvironment env)
        {
            services.AddAuthentication(options =>
            {
                options.DefaultAuthenticateScheme = JwtBearerDefaults.AuthenticationScheme;
            ...
            }).AddScheme<TokenAuthenticationOptions, GenericAuthenticationHandler>(authenticationService.Settings.Scheme,
                                             options => {
