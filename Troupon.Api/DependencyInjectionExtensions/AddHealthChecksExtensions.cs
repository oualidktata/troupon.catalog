...
using Troupon.Catalog.Service.Api.HealthCheckers;
    ...
    public static class AddHealthChecksExtensions
    {
        public static IServiceCollection AddHealthChecksToApplication(this IServiceCollection services,IConfiguration configuration)
        {
            ...
            _ = services.AddHealthChecks()
               ...
               .AddCheck<SchedulerCheckProvider>("Scheduler",null, tags: new[] { "scheduler", "all", "external" })
               .AddCheck<ErrorKPICheckProvider>("Errors KPI", null, tags: new[] { "Errors", "all", "internal" })
               .AddCheck("Identity server", () => HealthCheckResult.Degraded("Not going well!"), tags: new[] { "external", "all" })
               .AddCheck("Secure vault", () => HealthCheckResult.Healthy("All good!"), tags: new[] { "external", "all" })
               //Use specific extension for DBs or URI for sake of simplicity
               .AddSqlServer(connectionString, tags: new[] { "db","internal", "all" }, name: "Database")
               .AddUrlGroup(new System.Uri("https://www.google.ca"), tags: new[] { "uri", "all" }, name: "Google")
        ...
        public static IServiceCollection AddHealthChecksUIToApplication(this IServiceCollection services)
        {
            ...
            {//https://localhost:5001/healthchecks-ui
                ...
                //endpoints
                setup.AddHealthCheckEndpoint("All", "/health");
                setup.AddHealthCheckEndpoint("DataBases", "/health/db");
                setup.AddHealthCheckEndpoint("Urls", "/health/uri");
                setup.AddHealthCheckEndpoint("External Dependencies", "/health/external");
                setup.AddHealthCheckEndpoint("Internal dependencies", "/health/internal");
