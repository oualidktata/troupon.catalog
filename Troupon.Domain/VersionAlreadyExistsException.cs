...
namespace Troupon.Catalog.Core.Domain
{
    ...
    {
        public DealAlreadyExistsException(string message): base(message)
        {
    ...
    {
        public CRMIntergrationException(string message) : base(message)
        {

        }
        public CRMIntergrationException(string message,Exception exception) : base(message,exception)
        {
